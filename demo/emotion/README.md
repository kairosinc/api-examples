# Emotion Demo
## What it does
The Emotion Demo showcases the Kairos Emotion API by giving the user three methods for analyzing human emotions in a video stream.  In each method, video data is passed to the API, which returns a JSON object with frame by frame emotional values ranging from 1 to 100.  By implementing area graphs, the data is displayed visually to the user.
...
![Three Examples](/demo/emotion/docs/examples.png?raw=true)
...
![Video Display](/demo/emotion/docs/video_controls.png?raw=true)
...
![Face Alignment Graphic](/demo/emotion/docs/face_alignment.png?raw=true)
...
![Upload Form](/demo/emotion/docs/file_upload.png?raw=true)
